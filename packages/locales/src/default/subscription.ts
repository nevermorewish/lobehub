export default {
  'creditPack.title': "Buy credits",
  'creditPack.account': "Credits and billing",
  'creditPack.description': "One-time credit packs for platform models. No automatic renewal. Your own provider credentials do not consume platform credits.",
  'creditPack.empty': "No credit packs are available yet.",
  'creditPack.credits': "{{value}} credits",
  'creditPack.pay': "Pay {{amount}} with Alipay",
  'creditPack.returnHint': "Credits are added only after payment is verified. Pending orders refresh automatically.",
  'creditPack.available': "Available credits",
  'creditPack.reserved': "Reserved credits",
  'creditPack.holdHint': "Running requests reserve credits. When complete, only the actual charge is deducted and the remainder is released.",
  'creditPack.previous': "Previous",
  'creditPack.next': "Next",
  'creditPack.ledger': "Credit ledger",
  'creditPack.date': "Time",
  'creditPack.kindLabel': "Type",
  'creditPack.net': "Credit change / charge",
  'creditPack.grant': "Credits purchased",
  'creditPack.state': "Status",
  'creditPack.usage': "Model usage",
  'creditPack.model': "Model",
  'creditPack.input': "Input tokens",
  'creditPack.output': "Output tokens",
  'creditPack.status.pending': "Awaiting payment",
  'creditPack.status.paid': "Paid",
  'creditPack.status.closed': "Closed",
  'creditPack.status.hold': 'Reserved',
  'creditPack.status.settle_pending': 'Awaiting settlement',
  'creditPack.status.settled': "Settled",
  'creditPack.status.released': "Released",
  'creditPack.status.usage_missing': "Usage unavailable; not charged",
  'creditPack.status.recorded': "Processing",
  'creditPack.kind.credit': "Credit",
  'creditPack.kind.debit': "Charge",
  'creditPack.kind.hold': "Reserve",
  'creditPack.kind.release': "Release",
  'creditPack.kind.refund': "Refund",
